            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    ...
                    case R.id.main_radio0 :
                        ...
                        Toast.makeText(Main2Activity.this, "首页", Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case R.id.main_radio1 :
                        ...
                        Toast.makeText(Main2Activity.this, "吃货驾到", Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case R.id.main_radio2 :
                        ...
                        Toast.makeText(Main2Activity.this, "我的订单", Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case R.id.main_radio3 :
                        ...
                        Toast.makeText(Main2Activity.this, "个人中心", Toast.LENGTH_SHORT).show();
                        break;
